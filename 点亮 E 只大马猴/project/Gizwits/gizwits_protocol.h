...
* @{
*/
#define PRODUCT_KEY "77a16477e20d47ff81b09e5961d43dad"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "404690bc565a41a9be8a3fb46669ba02"
...
#define humi_MAX                           100
#define humi_LEN                           1
#define air_quality_RATIO                         1
#define air_quality_ADDITION                      0
#define air_quality_MIN                           0
#define air_quality_MAX                           100
#define air_quality_LEN                           1
...
typedef struct {
    ...
    uint32_t valuetemp;
    uint32_t valuehumi;
    uint32_t valueair_quality;
    uint32_t valueLight_intensity;
} dataPoint_t;

/** User Area Device State Structure */
typedef struct {
    uint8_t flagMottor:1;
    uint8_t flaghumier:1;
    uint8_t flagtemp:1;
    uint8_t flaghumi:1;
    uint8_t flagair_quality:1;
    uint8_t flagLight_intensity:1;
} dataPointFlags_t;
